...
public class frmCerraduraPositiva extends JFrame {
    public frmCerraduraPositiva() {
        setTitle("Cerradura Positiva");
        setSize(300, 150);
        ...
        aplicar.addActionListener(e -> {
            ...
            if (seleccionado != null) {
                seleccionado.cerraduraPositiva();
                JOptionPane.showMessageDialog(this, "✅ Cerradura positiva aplicada al AFN con ID " + idSeleccionado);
                dispose();
            } else {
