...
public class frmCerraduraKleene extends JFrame {
    public frmCerraduraKleene() {
        setTitle("Cerradura de Kleene");
        setSize(300, 150);
        ...
        List<AFN> listaAFNs = ProyectoAFN.listaAFNs; // Acceso directo a la lista
        ...
        aplicar.addActionListener(e -> {
            ...
            if (seleccionado != null) {
                // Aplicar cerradura y actualizar en la lista
                seleccionado.cerraduraKleene();
                JOptionPane.showMessageDialog(this, "✅ Cerradura de Kleene aplicada al AFN con ID " + idSeleccionado);
                dispose(); // cerrar ventana tras aplicar
            } else {
